const id = "24b/Week6.md";
						const collection = "docs";
						const slug = "24b/week6";
						...
						const data = {title:"Lesson 6",editUrl:true,head:[],template:"doc",sidebar:{hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/workspaces/learntk/client/src/content/docs/24b/Week6.md",
							rawData: undefined,
						};
