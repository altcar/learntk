...
import { s as starlightConfig, D as DeprecatedLabelsPropProxy } from './translations_CnOezYSw.mjs';
import { I as Icons, a as I18nBadgeConfigSchema, s as stripLeadingAndTrailingSlashes, H as HeadConfigSchema, B as BadgeConfigSchema, u as urlToSlug, b as slugToLocaleData, c as getSidebarFromConfig, d as getPrevNextLinks, e as getSiteTitle, f as getSiteTitleHref, h as getToC, i as parseAsyncWithFriendlyErrors, j as parseWithFriendlyErrors, $ as $$Page } from './Page_COWMzOww.mjs';
...
async function getUserDocsSchema() {
  const userCollections = (await import('./collection-config_D_viIUAA.mjs')).collections;
