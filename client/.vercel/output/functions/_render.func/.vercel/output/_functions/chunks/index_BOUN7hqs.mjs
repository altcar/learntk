...
import './StarlightPage_DFg_P31T.mjs';
import 'clsx';
...
const file = "/workspaces/learntk/client/src/content/docs/24b/index.mdx";
...
Content.moduleId = "/workspaces/learntk/client/src/content/docs/24b/index.mdx";
