...
import { $ as $$HeaderLink } from './HeaderLink_BvejspUw.mjs';
import 'clsx';
...
const file = "/workspaces/learntk/src/content/blog/using-mdx.mdx";
...
Content.moduleId = "/workspaces/learntk/src/content/blog/using-mdx.mdx";
